...
class TrajectoryFollowerFull(Node):
    def __init__(self):
        ...
        self.declare_parameter('Kv', 3.0)
        self.declare_parameter('Kphi', 4.0)
    ...
    def control_loop(self):
        ...
        for i in range(num_samples + 1):
            ...
            # Lấy giá trị nhỏ nhất (Nếu tương lai có cua gắt, phải đi chậm từ bây giờ)
        ...
        self.v_s = max(min(self.v_s + a_s * self.Ts, v_path_adaptive), 0.05)
        ...
        Kv = 2.0
        Kphi = 3.0
        self.Kv = Kv * min(t / 2.0, 1.0)
        self.Kphi = Kphi * min(t / 2.0, 1.0)
